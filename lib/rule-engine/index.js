...
var RuleEngine = function() {
  ...
  var findMatchesBySegments = function(segments, matchType, array) {
    return filterByMatchType(_.map(segments, function(segment) {
  ...
  var findMatches = function(rule, array) {
    if (!rule || !array || !array.length) { return []; }

    if (rule.segments) {
      return findMatchesBySegments(rule.segments, rule.matchType, array);
    }
